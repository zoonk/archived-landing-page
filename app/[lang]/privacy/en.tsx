    ...
    <article className="py-8 mx-auto mt-10 max-w-md">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p>
            This Privacy Policy applies to all websites managed by{" "}
            <em>Zoonk Tecnologia e Educação Ltda.</em>, including - but not
            limited to - UneeBee, Wikaro, Wisek, Educasso and Ikidoo, detailing
        ...
        <section>
          ...
          <p>
            Your passwords are encrypted but other data is not encrypted. In the
            event of a data breach, we will promptly inform affected users.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your data is retained only as long as your account is active. Upon
            account deletion, all associated data is permanently erased without
